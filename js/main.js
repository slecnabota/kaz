...
/* */
// let information = [
//   {type: 'Фронтальные погрузчики', models: ['Фронтальный погрузчик XCMG LW300FN', 'Фронтальный погрузчик XCMG LW330FN']},
//   {type: 'Мини-погрузчики', models: ['Мини-погрузчик XCMG SR740K', 'Мини-погрузчик XCMG SR760K']},
// ]
...
const information = [
  {
      ...
      models: [
          "Фронтальный погрузчик XCMG LW300FN",
          "Фронтальный погрузчик XCMG LW330FN",
      ],
  },
  {
      type: "Мини-погрузчики",
...
function openModalWithData(event) {
  ...
  let category = parentBlock
    .closest(".catalog__block-content")
